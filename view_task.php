...
if (!$task) {
    echo '<div class="alert alert-danger container mt-4">Task not found or invalid ID.</div>';
...
// Fetch Reactions for each comment (using a query for all reactions of these comments)
$reactions_data = [];
if (!empty($comments)) {
